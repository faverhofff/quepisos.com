...
(function($){
    ...
    function banner_parallax(){
        ...
        if($('.header-media .banner-parallax').length){
            ...
            if(parallax_scroll_top >= start_scroll){
                ...
                parallax_ele.css("transform","translate3d(0,"+-scrolled*-1+"px,0)");
    ...
    function setSectionHeight() {
        ...
        $('.banner-parallax-fix').css( 'height', topBarsHeight + 100 );
    ...
    .on( "idle.idleTimer", function(event, elem, obj){
        window.location.href= $("#url").val() + "/index.php/lock";
    })
    ...
    $.vegas('slideshow', {
      ...
      backgrounds:[
        ...
        { src:'images/backgrounds/bg9.jpg', fade:1000 },
        { src:'images/backgrounds/bg10.jpg', fade:1000 },
        { src:'images/backgrounds/bg11.jpg', fade:1000 },
        { src:'images/backgrounds/bg12.jpg', fade:1000 },
        { src:'images/backgrounds/bg13.jpg', fade:1000 },
        { src:'images/backgrounds/bg14.jpg', fade:1000 },
        { src:'images/backgrounds/bg15.jpg', fade:1000 },
        { src:'images/backgrounds/bg16.jpg', fade:1000 },
        { src:'images/backgrounds/bg17.jpg', fade:1000 }
      ]
    });
