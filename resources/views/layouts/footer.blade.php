    ...
    <footer class="footer-v2">
        ...
        <div class="footer-bottom" style="padding-top: 20px;background-color: white;color:#004274;margin-bottom: -20px;padding-bottom: 0px;">
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-3">
                        <div class="footer-col">
                            <p><img src="images/houzez-logo-color.png" alt="logo"></p>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6">
                        <div class="col-md-3 col-sm-3">
                    ...
                    <div class="col-md-3 col-sm-3">
                        <div class="footer-col foot-social foot-b-social">
                            <p>                              
                                <a target="_blank" class="btn-facebook" href="https://facebook.com/Favethemes"><i class="fa fa-facebook-square"></i></a>
